...
const sheetVariants = cva("fixed z-50 gap-4 bg-background shadow-lg", {
	variants: {
		side: {
			top: "inset-x-0 top-0 border-b data-[state=closed]:-translate-y-full data-[state=open]:translate-y-0 transition-transform duration-300",
			bottom:
				"inset-x-0 bottom-0 border-t data-[state=closed]:translate-y-full data-[state=open]:translate-y-0 transition-transform duration-300",
			left: "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:-translate-x-full data-[state=open]:translate-x-0 transition-transform duration-300 sm:max-w-sm",
			right:
...
>(
	(
		...
		<SheetPortal>
			<SheetOverlay transparent={transparent} />
